  ...
  where TTarget : class, IEquatable<TTarget>, IEquatable<int>, IComparable<TTarget>
{
  ...
  public static AbsenceTypeRelation<TSource, TTarget> Create(TSource source, TTarget target, bool export = false)
  {
    return new AbsenceTypeRelation<TSource, TTarget>
    {
      Source = source,
  ...
  {
    return Target is null ? $"{Source} wird ignoriert und daher nicht exportiert" : $"{Source} => {Target}";
  }
}
