...
public partial class ClockodoUserForm : UserControl, IExportAbsences<ClockodoAbsenceType>
{
  ...
  public async Task<IImmutableList<AbwesenheitseintragOhneMapping<ClockodoAbsenceType>>> AllAbsences(
    DateTime start,
    DateTime ende,
  ...
  )
  {
    ...
    if (periodfilter.IsFailure)
    {
      ...
      return new List<AbwesenheitseintragOhneMapping<ClockodoAbsenceType>>().ToImmutableList();
    }
