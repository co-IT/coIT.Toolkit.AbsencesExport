...
internal class IsHalfSicknessDay<TSource, TTarget> : Spezifikation<Abwesenheitseintrag<TSource, TTarget>>
{
  public override Expression<Func<Abwesenheitseintrag<TSource, TTarget>, bool>> ToExpression()
  {
    return abwesenheit =>
      abwesenheit.ZielTyp == null
        ? false
        : abwesenheit.ZielTyp.ToString().ToLower().Contains("krank") && abwesenheit.AbwesenheitsTage % 1 != 0;
  }
